...
namespace DrinkAndRate.Web
{
	public partial class ErrorPage : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			Exception ex = this.Application[Global.APPLICATION_ERROR] as Exception;
			if (ex == null)
			{
				ex = Server.GetLastError();
			}

			this.Application[Global.APPLICATION_ERROR] = null;
			...
			if (Request.IsLocal)
			{
				...
				{
					InnerMessage.Text = ex.GetType().ToString() + "<br/>" + ex.InnerException.ToString();
