<%@ Page Title="CountriesGrid" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CountriesGrid.aspx.cs" Inherits="DrinkAndRate.Web.Admin.CountriesGrid" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	<asp:UpdatePanel ID="UpdataPanel" runat="server">
		<ContentTemplate>
			<h3 class="text-center alert alert-dismissable alert-success" id="headerInfo" runat="server">Countries Grid</h3>
			<div class="row">
				<div class="col-md-12">
